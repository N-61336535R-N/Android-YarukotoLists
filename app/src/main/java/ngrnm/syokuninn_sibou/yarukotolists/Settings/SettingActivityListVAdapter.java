...
public class SettingActivityListVAdapter extends BaseAdapter {
    ...
    public SettingActivityListVAdapter(Context context, int itemLayoutId, String[] scenes, int[] photos) {
        super();
