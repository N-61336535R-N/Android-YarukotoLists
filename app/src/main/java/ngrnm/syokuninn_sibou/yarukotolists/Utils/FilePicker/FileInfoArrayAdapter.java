package ngrnm.syokuninn_sibou.yarukotolists.Utils.FilePicker;
...
public class FileInfoArrayAdapter extends ArrayAdapter<FileInfo> {
    ...
    // コンストラクタ
    public FileInfoArrayAdapter(Context context, List<FileInfo> objects) {
